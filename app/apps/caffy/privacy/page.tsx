...
export const metadata = {
  ...
  description: "Caffyアプリのプライバシーポリシー",
};
        ...
        <div className="glass-card rounded-3xl p-8 md:p-12 space-y-8">
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              ...
              <li>
                位置情報は「使用中のみ」収集され、バックグラウンド追跡は行いません
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              ...
              <li>
                投稿閲覧履歴（IPアドレス、ユーザーエージェントを含む可能性があります）
              </li>
              <li>いいね、保存、フォロー履歴</li>
              <li>アプリ設定、テーマ設定</li>
            </ul>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              <li>
                Stripe決済情報（カード情報はStripeが管理し、Caffyは保存しません）
              </li>
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Caffy
              は、サービス提供のために以下の第三者サービスと情報を共有します：
            </p>

            <h3 className="text-xl font-semibold mb-3 text-white mt-6">
              3.1 Supabase（バックエンドインフラ）
            </h3>
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              <li>
                共有する情報：すべてのユーザーデータ（アカウント、投稿、写真など）
              </li>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              <li>
                共有する情報：メールアドレス、ユーザーID、サブスクリプション情報
              </li>
              <li>目的：プレミアムサブスクリプションの決済処理</li>
              <li>
                注：クレジットカード情報はCaffyに保存されず、Stripeが直接管理します
              </li>
              <li>
                プライバシーポリシー：
                <a
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              <li>
                Apple Sign-In：Apple ID、メールアドレス（任意）、名前（任意）
              </li>
              <li>
                Google Sign-In：Google
                ID、メールアドレス、名前、プロフィール写真（任意）
              </li>
              <li>認証時のみ情報を共有し、サインイン完了後は共有されません</li>
            </ul>

            <p className="text-gray-300 leading-relaxed mt-6">
              <strong>データ販売について：</strong>
              Caffyは、ユーザーの個人情報を第三者に販売することは一切ありません。
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              ...
              <li>
                <strong>公開投稿：</strong>
                カフェレビュー、写真、評価、メニュー情報、位置情報
              </li>
              <li>
                <strong>ソーシャル情報：</strong>
                友達リスト、いいね、保存（プライバシー設定による）
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              ...
              <li>
                <strong>非公開：</strong>自分のみがプロフィールと投稿を閲覧可能
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              ...
              <li>
                行レベルセキュリティ（RLS）により、ユーザーは自分のデータのみアクセス可能
              </li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              <li>
                投稿の閲覧履歴（ユーザーID、投稿ID、タイムスタンプ、IPアドレス、ユーザーエージェント）
              </li>
              <li>検索クエリと結果</li>
            ...
            <p className="text-gray-300 leading-relaxed mt-4">
              <strong>重要：</strong>
              Caffyは、第三者のアナリティクスツール（Google
              Analytics、Facebookピクセルなど）や広告SDKを使用していません。すべてのデータ収集は、アプリ内の機能向上のみに使用されます。
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-300 leading-relaxed space-y-2 ml-4">
              <li>
                <strong>アクセス権：</strong>
                自身のプロフィールと投稿データを閲覧できます
              </li>
              <li>
                <strong>修正権：</strong>プロフィール情報や投稿を編集できます
              </li>
              <li>
                <strong>削除権：</strong>個別の投稿やアカウント全体を削除できます
              </li>
              <li>
                <strong>プライバシー管理：</strong>
                プロフィールの公開範囲を設定できます（全員/友達のみ/非公開）
              </li>
              <li>
                <strong>通知管理：</strong>
                プッシュ通知やメール通知の設定を変更できます
              </li>
            </ul>
